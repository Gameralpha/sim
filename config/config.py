...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Gameralpha/sim",
)
...
AUTO_LEAVING_ASSISTANTT = getenv("AUTO_LEAVING_ASSISTANT", "True")

# Time after which you're assistant account will leave chats automatically.
AUTO_LEAVE_ASSISTANT_TIME = int(
    getenv("ASSISTANT_LEAVE_TIME", "30")
...
TG_AUDIO_FILESIZE_LIMIT = int(
    getenv("TG_AUDIO_FILESIZE_LIMIT", "1048576007876889999")
)  # Remember to give value in bytes

TG_VIDEO_FILESIZE_LIMIT = int(
    getenv("TG_VIDEO_FILESIZE_LIMIT", "1073741824627728289292929")
)  # Remember to give value in bytes
